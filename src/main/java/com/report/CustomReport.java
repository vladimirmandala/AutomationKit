...
public class CustomReport implements IReporter {
    ...
    protected void writeStylesheet() {
        ...
        writer.print(".stripe td {background-color: black}");
        ...
        writer.print(".failedeven td,.stripe .attn {background-color: rgb(255, 255, 0)}");
    ...
    protected void writeSuiteSummary() {
        ...
        //writer.print("<table>");
        writer.print("<table cellpadding=0 cellspacing=0 width=1300 border=2 bordercolor=black>");
        writer.print("<tr><th colspan=\"7\">");
        writer.print( "Test Summary Report" );
        writer.print("</th></tr>");
        writer.print("<tr>");
    ...
    protected void writeScenarioSummary() {
        ...
        writer.print( "Test Case List Summary");
        ...
        for ( ClassResult classResult : classResults ) {
            ...
            for ( MethodResult methodResult : classResult.getMethodResults() ) {
                ...
                for ( ITestResult result : results ) {
                	 writer.print("writeScenarioDetails = scenarioIndex =  "+scenarioIndex+" label = " +label+ "Result " +result.getStatus());
    ...
    /**
     * Writes the details for an individual test scenario. This method writes test step
     */
    private void writeScenario(int scenarioIndex, String label,ITestResult result) {
        ...
        writer.print("<table class=\"result\" border =1 >");
