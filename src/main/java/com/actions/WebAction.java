...
public abstract class WebAction {
	 ...
	 * @throws MyException
	 */
	public void isLinkBroken() throws MyException{       
  ...
  /**
   * Purpose : This method verifies that link is active
   * @param link - link(URL)
   * @return - true/false
   */
   public void verifyLinkActive(String linkUrl) throws MyException{
      try {
        ...
        if(httpURLConnect.getResponseCode()==HttpURLConnection.HTTP_NOT_FOUND)  
         ...
         throw new MyException("MalformedURLException Error : "+e);
      } catch (IOException e) {
    	  throw new MyException("IOException Error : "+e);
      } catch (Exception e) {
    	  throw new MyException("Exception Error : "+e);
      }
  } 
